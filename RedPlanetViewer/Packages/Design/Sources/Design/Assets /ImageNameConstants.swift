...
public extension ImageNameConstant {
    ...
    static let closeIcon: Self = "close-icon"
    static let lightCloseIcon: Self = "light-close-icon"
    static let historyIcon: Self = "history-icon"
    static let leftIcon: Self = "left-icon"
